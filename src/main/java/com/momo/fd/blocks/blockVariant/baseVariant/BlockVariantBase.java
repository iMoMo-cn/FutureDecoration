package com.momo.fd.blocks.blockVariant.baseVariant;
...
public class BlockVariantBase extends Block implements IMetaName, IHasModel
{
    ...
    public BlockVariantBase(String name, Material material, MapColor mapColor, int maxUsedVariants, int burnTime)
    {
        ...
        ModItems.ITEMS.add(new ItemBlockVariants(this, maxUsedVariants){
            @Override
    ...
    {
        this(name, material, mapColor, maxUsedVariants, -1);
    }
