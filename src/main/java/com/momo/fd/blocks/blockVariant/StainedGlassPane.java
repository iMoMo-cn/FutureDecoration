...
public class StainedGlassPane extends BlockPane implements IHasModel, IMetaName
{
    ...
    public StainedGlassPane(String name, int maxUsedVariants) {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, Boolean.valueOf(false)).withProperty(EAST, Boolean.valueOf(false)).withProperty(SOUTH, Boolean.valueOf(false)).withProperty(WEST, Boolean.valueOf(false)).withProperty(VARIANT, EnumVariants.Block0));
    }
