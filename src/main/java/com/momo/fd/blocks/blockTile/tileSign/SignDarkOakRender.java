package com.momo.fd.blocks.blockTile.tileSign;
...
public class SignDarkOakRender extends TileEntitySignRenderer {
    private static final ResourceLocation SIGN_TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/entity/signs/dark_oak.png");
    ...
    public void render(TileEntitySign te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (block == ModBlocks.DARK_OAK_SIGN_STANDING)
        {
