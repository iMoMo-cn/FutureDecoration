...
public class SignBirchRender extends TileEntitySignRenderer {
    private static final ResourceLocation SIGN_TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/entity/signs/birch.png");
    ...
    public void render(TileEntitySign te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (block == ModBlocks.BIRCH_SIGN_STANDING)
        {
