...
import com.momo.fd.blocks.blockInteractive.Smoker;
...
public class TileEntitySmoker extends TileEntity implements ITickable {
    ...
    {
        return this.hasCustomName() ? this.smokerCustomName : "tile.smoker.name";
    }
    ...
    {
        if(oldState.getBlock() == ModBlocks.SMOKER && newSate.getBlock() == ModBlocks.SMOKER){
            return false;
        }
        else
    ...
    public static boolean isBurning(TileEntitySmoker tileSmoker)
    {
