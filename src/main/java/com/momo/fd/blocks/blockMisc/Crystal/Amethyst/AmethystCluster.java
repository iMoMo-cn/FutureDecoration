...
public class AmethystCluster extends DirectionalBlock {
    ...
    private int shardMeta;

    public AmethystCluster(String name, MapColor mapColor, int shardMeta) {
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) { return ModItems.CRYSTAL_SHARD; }
