...
public class Smoker extends BlockContainer implements IHasModel {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntitySmoker)
            {
                ...
                playerIn.openGui(MoMoFramework.MODID, GuiHandler.SMOKER, worldIn, x, y, z);
            }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tileEntity instanceof TileEntitySmoker) {
            final ItemStackHandler inventory = ((TileEntitySmoker) tileEntity).inventory;
    ...
    {
        return new ItemStack(ModBlocks.SMOKER);
    }
