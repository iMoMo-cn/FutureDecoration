package com.momo.fd.util.NBTStrDef;
...
public class IDLNBTDef {
	...
	public static final String IMPRINT_DESC = MoMoFramework.MODID + ".imprint.desc";
	...
	//prefix
	public static final String MSG_PREFIX = MoMoFramework.MODID + ".msg.";
	...
	public static final String SENTRY = "sentry";//don't wander
